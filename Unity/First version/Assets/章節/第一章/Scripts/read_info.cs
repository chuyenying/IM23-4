...
public class read_info : MonoBehaviour
{
    ...
    [SerializeField] private UnityEvent ChangeFlower_PlayTimeline, ChangeFlower_CloseTimeline;
    private bool PlayerTimelineAlready = false;
    ...
    private void Update()
    {
        ...
        else if (SelectionManager_bro.name == "花瓶")
        {
            ...
            candy.SetActive(false);
            phone.SetActive(false);
            if (!PlayerTimelineAlready)
            {
                ChangeFlower_PlayTimeline.Invoke();
                StartCoroutine("WaitTimelineDone");
            }
    ...
    IEnumerator WaitTimelineDone()
    {
        PlayerTimelineAlready = true;
        yield return new WaitForSeconds(7f);
        ChangeFlower_CloseTimeline.Invoke();
    }
}
