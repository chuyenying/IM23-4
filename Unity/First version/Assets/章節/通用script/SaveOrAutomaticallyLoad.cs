...
public class SaveOrAutomaticallyLoad : MonoBehaviour
{
    public GameObject FirstPerson;
    [SerializeField] private GameObject cellphone_LockPage , cellphone_MainPage;
    [SerializeField] private GameObject cellphone_ontable , candy_ontable;
    private void Awake()
    {
    ...
    public void Automatically_LoadScene()
    {
        if (PlayerPrefs.GetInt("Automatically_LoadScene") == 1)
        {
            ...
            cellphone_ontable.SetActive(!data.Take_Cellphone);
            ...
            candy_ontable.SetActive(!data.Take_Candy);
